...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SoundHX", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SoundHX", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5";
		app.meta["company"] = "TreeFortress";
		app.meta["file"] = "SoundHX";
		app.meta["name"] = "SoundHX";
		app.meta["packageName"] = "com.treefortress.soundhx";
